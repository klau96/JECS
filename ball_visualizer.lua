...
-- TODO: Remove, testing for player-chunk bounding check
...
function spawnPelletsForChunk(chunk : Part)
	...
	for x = 5, cx-1, pelletSpacing do -- chunk size X - 1, prevents inclusion of ending
...
PingChunkRemote.OnServerEvent:Connect(function(player: Player, hash)
